...
const SYSTEMS = {
  ...
  kamerove: {
    ...
    content: [
      ...
      "Preto je veľmi dôležité zvoliť také komponenty kamerového systému, ktoré zodpovedajú požiadavkám náročnosti aplikácie, veľkosti sledovaného objektu, spôsobu spracovania a prenosu signálu, odolnosti voči poveternostným podmienkam a pod. Všetky uvedené kritéria by potom mali jednoznačne určiť, či je na danú inštaláciu vhodná analógová alebo IP technológia, čiernobiele alebo farebné kamery s nočným videním, prisvietením, polohovaním a priblížením (tzv. PTZ systémy) alebo dome kamery, či je výhodnejší záznam videa do PC pomocou digitalizačných kariet alebo na harddisk digitálneho videorekordéra. S rastúcimi nárokmi na kvalitu obrazu prichádzajú od výrobcov stále nové technické riešenia, preto je inovácia v tomto segmente zabezpečenia objektov veľmi rýchla. Ku kamerovým systémom patria tiež video doplnky (prevodníky formátov obrazu, prepínače obrazu a kvadrátory, zosilňovače, napájacie zdroje) a inštalačný materiál (kryty na kamery, držiaky, kabeláž a pod.)"
    ]
  },
  pristupove: {
  ...
  return (
    <section className="min-h-screen bg-[#141414] text-white">
      ...
      <div className="max-w-4xl flex flex-col gap-10 mx-auto px-4 py-12">
        ...
        <Link href="/#bezpecnostne-systemy" className="text-blue-400 hover:text-blue-300 inline-flex items-center mb-8">
